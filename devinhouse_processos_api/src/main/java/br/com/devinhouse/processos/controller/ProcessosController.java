...
public class ProcessosController {
	...
	@RequestMapping(value = "/v1/cadastrar", method = POST, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/v1/consultar", method = GET, produces = APPLICATION_JSON_VALUE)
	public List<Processo> allProcess() {
		return service.getAllProcess();
	}
	
	// endpoint de consulta de processos por id
	@RequestMapping(value = "/v1/consultar/id/{id}", method = GET, produces = APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/v1/atualizar/id/{id}", method = PUT, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/v1/remover/id/{id}", method = DELETE)
